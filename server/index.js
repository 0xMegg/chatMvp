...
io.on("connection", function (socket) {
    ...
    // ✅ 방 입장
    socket.on("join", function (roomId) { return __awaiter(void 0, void 0, void 0, function () {
        var pastMessages;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    socket.join(roomId);
                    console.log("\uD83D\uDEAA ".concat(socket.id, " \uBC29 \uC785\uC7A5: ").concat(roomId));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma_1.prisma.message.create({ data: msg })];
                case 1:
                    saved = _a.sent();
                    // 해당 방에만 브로드캐스트
